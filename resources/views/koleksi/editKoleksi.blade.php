                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form action="{{ route('koleksi.update', $koleksi->id) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="jumlahKeluar" id="jumlahKeluar" class="mt-1 p-2 border rounded-md w-full" value="{{ $koleksi->jumlahKeluar }}" required max="{{ $koleksi->jumlahKoleksi }}">
                        </div>
